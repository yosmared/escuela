...
use Escuela\CoreBundle\Form\GradeType;
...
class GradeController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('EscuelaCoreBundle:Grade')->findAll();
     ...
     * @Method("POST")
     * @Template("EscuelaCoreBundle:Grade:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('EscuelaCoreBundle:Grade')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("EscuelaCoreBundle:Grade:edit.html.twig")
     */
