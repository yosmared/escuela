...
use Escuela\CoreBundle\Form\SectionType;
...
class SectionController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('EscuelaCoreBundle:Section')->findAll();
     ...
     * @Method("POST")
     * @Template("EscuelaCoreBundle:Section:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('EscuelaCoreBundle:Section')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("EscuelaCoreBundle:Section:edit.html.twig")
     */
